...
PARSER = escape_split parser_utils parser parser_wildcard_phase prompt_helpers \
         ...
         syntax_utils syntax_helpers_utils syntax syntax_helpers3 syntax_helpers4
REDIR  = cmd_redir exec_redir heredoc_utils redir_helpers redir_utils utils_redir \
